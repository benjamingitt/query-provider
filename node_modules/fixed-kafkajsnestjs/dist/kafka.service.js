...
const nestjskafka_1 = require("@kbarreto23/nestjskafka");
...
let KafkaService = KafkaService_1 = class KafkaService {
    constructor(options) {
        ...
        this.kafka = new nestjskafka_1.Kafka(Object.assign(Object.assign({}, client), { logCreator: kafka_logger_1.KafkaLogger.bind(null, this.logger) }));
